...
const MobileNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg md:hidden z-50 safe-area-pb">
      <div className="flex justify-around items-center h-14 md:h-16">
        {filteredNavItems.map((item) => (
          ...
          >
            ...
            <span className="text-[10px] md:text-xs mt-0.5 font-medium">{item.label}</span>
          </Link>
        ))}
      </div>
    </div>
